...
class Point(object):
    ...
    def get_distance_from(self, point):
        distance_x = (point.x - self.x) ** 2
        distance_y = (point.y - self.y) ** 2
        distance = (distance_x + distance_y) ** .5
        return distance

    def get_distance_from_start(self,):
        distance_x = (self.x - self.start_x) ** 2
        distance_y = (self.y - self.start_y) ** 2
        distance = (distance_x + distance_y) ** .5
        return distance
